...
# Geometry: directions
ORIGIN: Vector = np.array((0.0, 0.0, 0.0))
"""The center of the coordinate system."""

UP: Vector = np.array((0.0, 1.0, 0.0))
"""One unit step in the positive Y direction."""

DOWN: Vector = np.array((0.0, -1.0, 0.0))
"""One unit step in the negative Y direction."""

RIGHT: Vector = np.array((1.0, 0.0, 0.0))
"""One unit step in the positive X direction."""

LEFT: Vector = np.array((-1.0, 0.0, 0.0))
"""One unit step in the negative X direction."""

IN: Vector = np.array((0.0, 0.0, -1.0))
"""One unit step in the negative Z direction."""

OUT: Vector = np.array((0.0, 0.0, 1.0))
"""One unit step in the positive Z direction."""

# Geometry: axes
X_AXIS: Vector = np.array((1.0, 0.0, 0.0))
Y_AXIS: Vector = np.array((0.0, 1.0, 0.0))
Z_AXIS: Vector = np.array((0.0, 0.0, 1.0))
